...
use agentum_core::{
    BoardComment, BoardItem, BoardLink, BoardPatch, LOCAL_HOST_ID, LinkKind, NewBoardComment,
    NewBoardItem, NewSession, ReorderEntry, RequiredField, Session, Status, TrackerBinding, User,
};
...
mod tests {
    ...
    use agentum_core::{HostKind, NewChannel, NewHost, NewMessage, NewNote, NotePatch, SshAuth};
