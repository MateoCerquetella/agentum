...
impl Store {
    ...
    pub async fn create_board_item(&self, new: NewBoardItem) -> Result<BoardItem> {
        ...
        Ok(BoardItem {
            ...
            // Native cards have no external linkage; the sync engine sets
            // these via `upsert_external_card`, never this path.
    ...
    // ---------- board ↔ external tracker sync (spec 014a) ----------
...
struct BoardItemRow {
    ...
    /* ---- external tracker linkage (migration 0022) ---- */
    #[sqlx(default)]
