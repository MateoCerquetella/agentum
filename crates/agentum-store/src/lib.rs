...
use agentum_core::{
    ...
    NewSession, ReorderEntry, RequiredField, Session, Status, TrackerBinding, User,
};
...
mod tests {
    ...
    use agentum_core::{
        HostKind, LOCAL_HOST_ID, NewChannel, NewHost, NewMessage, NewNote, NotePatch, SshAuth,
    };
