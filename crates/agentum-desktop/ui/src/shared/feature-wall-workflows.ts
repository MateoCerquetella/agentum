...
export const FEATURE_WALL_WORKFLOWS: readonly FeatureWallWorkflow[] = [
  {
    ...
    lede: 'Agentum splits each task into an isolated workspace so agents can run in parallel.',
  ...
  },
  {
    ...
    lede: 'Bring your terminal setup into Agentum, then split panes to keep servers, tests, logs, and agents running side by side.',
