// Per-step copy for the workbench tile in the Explore Agentum modal. Mirrors
...
export const WORKBENCH_STEPS: readonly WorkbenchStep[] = [
  ...
  },
  {
    ...
    name: 'Editor',
    subtitle: 'Editor',
    description: 'Use our Notion-style markdown editor to write notes without leaving Agentum.'
  },
  {
    id: 'browser',
    name: 'Browser',
    subtitle: 'Browser',
    description:
      "Run your app in Agentum's browser, send selected UI elements to agents, and let your agents interact with your webpage."
  }
] as const
