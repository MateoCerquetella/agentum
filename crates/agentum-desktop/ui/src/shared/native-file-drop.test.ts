...
import {
  ...
  AGENTUM_INTERNAL_FILE_DRAG_TYPE,
...
describe('hasNativeFileDragTypes', () => {
  ...
  it('rejects internal Agentum file moves and URL/text drags', () => {
    expect(hasNativeFileDragTypes(['Files', AGENTUM_INTERNAL_FILE_DRAG_TYPE])).toBe(false)
