...
export const FEATURE_WALL_TILES: readonly FeatureWallTile[] = [
  {
    ...
    docsUrl: 'https://www.onagentum.dev/docs/model/worktrees'
  },
  {
    id: 'tile-02',
    kind: 'media',
    ...
    owner: 'terminal',
    docsUrl: 'https://www.onagentum.dev/docs/terminal'
  },
  {
    id: 'tile-03',
    kind: 'media',
    ...
    caption:
      'Find connected GitHub or Linear work in Tasks and author a reviewed Agentum spec without switching tools.',
    gifPath: 'tile-03.gif',
  ...
  },
  {
    ...
    docsUrl: 'https://www.onagentum.dev/docs/browser/design-mode'
  },
  {
    id: 'tile-06',
    kind: 'media',
    ...
    caption:
      'Run agents on a remote machine with the same Agentum editing, git, and terminal workflow.',
    gifPath: 'tile-06.gif',
    posterPath: 'tile-06.poster.jpg',
    recordedAtPath: 'tile-06.recorded-at.json',
    owner: 'ssh-workspaces',
    docsUrl: 'https://www.onagentum.dev/docs/ssh'
  },
  {
    id: 'tile-07',
    kind: 'media',
    ...
    owner: 'editor',
    docsUrl: 'https://www.onagentum.dev/docs/editing/file-explorer'
  },
  {
    id: 'tile-08',
    kind: 'media',
    ...
    owner: 'diff-review',
    docsUrl: 'https://www.onagentum.dev/docs/review/annotate-ai-diff'
  },
  {
    id: 'tile-09',
    kind: 'media',
  ...
  },
  {
    ...
    owner: 'keyboard-ux',
    docsUrl: 'https://www.onagentum.dev/docs/model/quick-open'
  },
  {
    id: 'tile-11',
    kind: 'media',
    ...
    docsUrl: 'https://www.onagentum.dev/docs/agents/usage-tracking'
  },
  {
    id: 'tile-12',
    kind: 'media',
    ...
    owner: 'file-preview',
    docsUrl: 'https://www.onagentum.dev/docs/editing/viewers'
  }
] as const
