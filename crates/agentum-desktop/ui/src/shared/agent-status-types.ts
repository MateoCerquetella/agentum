...
// These types define the normalized status that Agentum receives from Claude,
...
export type AgentStateHistoryEntry = {
   ...
   *  (for example Claude Code `is_interrupt`) or Agentum's guarded interrupt
...
export type AgentStatusEntry = {
   ...
   *  inferred by Agentum's guarded interrupt fallback.
