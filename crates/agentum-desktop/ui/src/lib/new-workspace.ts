...
// Why: when a repo has no `agentum.yaml` issueCommand and no per-user override,
...
function getDefaultTabCommandPreview(yamlHooks: AgentumHooks | null): string {
 ...
 * their `agentum.yaml` / `.agentum/issue-command` yet.
 */
