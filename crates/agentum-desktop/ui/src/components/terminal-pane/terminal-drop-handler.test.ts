...
describe('handleTerminalFileDrop', () => {
  ...
  it('uploads client-local drops into the active runtime before pasting paths', async () => {
      ...
      results: [
        {
          ...
          status: 'imported',
          destPath: '/remote/repo/.agentum/drops/logo.png',
          kind: 'file',
          renamed: false
        }
      ]
    ...
    expect(mocks.importExternalPathsToRuntime).toHaveBeenCalledWith(
      ...
      ['/Users/me/logo.png'],
      '/remote/repo/.agentum/drops'
    )
    expect(sendInput).toHaveBeenCalledWith('/remote/repo/.agentum/drops/logo.png ')
  ...
  it('uses Windows shell paths for forward-slash UNC runtime worktrees', async () => {
      ...
      results: [
        {
          sourcePath: '/Users/me/logo.png',
          status: 'imported',
          destPath: '//server/share/repo\\.agentum\\drops\\logo.png',
          kind: 'file',
          renamed: false
        }
      ]
    ...
    expect(mocks.importExternalPathsToRuntime).toHaveBeenCalledWith(
      ...
      ['/Users/me/logo.png'],
      '\\\\server\\share\\repo\\.agentum\\drops'
    )
    expect(sendInput).toHaveBeenCalledWith('\\\\server\\share\\repo\\.agentum\\drops\\logo.png ')
  })
})
...
describe('resolveTerminalDropTargetShell', () => {
  ...
  it('uses runtime worktree path shape for active POSIX runtimes', () => {
    expect(
      resolveTerminalDropTargetShell({
        activeRuntimeEnvironmentId: 'env-1',
        worktreePath: '/home/agentum/repo',
        connectionId: null,
