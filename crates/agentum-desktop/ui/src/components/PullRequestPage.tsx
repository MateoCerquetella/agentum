...
import { ConversationTab, PRFilesCombinedDiffViewer } from './pull-request-conversation'
...
import { ArrowRight, Check, ChevronDown, ChevronLeft, CircleDot, Copy, ExternalLink, FileText, FolderKanban, GitPullRequest, ListChecks, LoaderCircle, MessageSquare, Plus } from 'lucide-react'
      ...
      <div className="flex-none border-b border-border/60 px-6 py-4">
        <div className="flex items-start gap-4">
          ...
          <div className="flex shrink-0 items-center gap-2">
            {/* Why: Agentum's signature affordance — keep this primary so it stands out
