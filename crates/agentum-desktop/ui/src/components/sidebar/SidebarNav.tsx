  ...
  return (
    <div className="flex flex-col gap-0.5 px-2 pt-2 pb-1">
      {/* Primary workflow rail (Phase 1 nav shell, #48): Mission Control → Chat
          → Projects. The Board is no longer a rail entry (#360) — it lives
          inside each project's hub (Projects → hub → Tasks tab), bound to that
          project's tracker. Settings lives in the bottom toolbar. */}
      <PrimaryNavItem
        icon={Radar}
