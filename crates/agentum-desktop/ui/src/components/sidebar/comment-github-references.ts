// Pure (react-markdown-free) GitHub issue/PR autolink logic for comment
// rendering. Kept in its own module so the heavy markdown renderer can be
// lazy-loaded (see CommentMarkdown.tsx) without dragging this — or its test —
// into the eager startup chunk. This file must NOT import react-markdown.
