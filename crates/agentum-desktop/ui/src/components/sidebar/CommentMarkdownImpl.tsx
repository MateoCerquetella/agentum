...
import type { CommentMarkdownProps } from './CommentMarkdown'
...
// markdown via `agentum worktree set --comment` and have it render nicely.
...
const CommentMarkdownImpl = React.memo(
  React.forwardRef<HTMLDivElement, CommentMarkdownProps>(function CommentMarkdownImpl(
...
export default CommentMarkdownImpl
