...
// task as a work-item source. Leaking the remote name would imply Agentum
...
export function sameGitHubOwnerRepo(
  ...
  // different casing (e.g. mateocerquetella/Agentum vs mateocerquetella/agentum) resolve to the
