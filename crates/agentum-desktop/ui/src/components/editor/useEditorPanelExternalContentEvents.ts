...
export function useEditorPanelExternalContentEvents({
  ...
  useEffect(() => {
    ...
    window.addEventListener(AGENTUM_EDITOR_EXTERNAL_FILE_CHANGE_EVENT, handler as EventListener)
    return () =>
      window.removeEventListener(AGENTUM_EDITOR_EXTERNAL_FILE_CHANGE_EVENT, handler as EventListener)
  ...
  useEffect(() => {
    ...
    window.addEventListener(AGENTUM_EDITOR_FILE_SAVED_EVENT, handler as EventListener)
    return () => window.removeEventListener(AGENTUM_EDITOR_FILE_SAVED_EVENT, handler as EventListener)
