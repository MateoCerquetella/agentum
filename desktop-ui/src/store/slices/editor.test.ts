...
describe('createEditorSlice floating editor activation', () => {
  ...
  it('opens floating markdown tabs without changing the main active editor surface', () => {
    ...
    store.getState().openFile({
      filePath: '/tmp/agentum/untitled.md',
...
describe('createEditorSlice activateMarkdownLink', () => {
  ...
  it('can open a local file without adopting the currently active runtime owner', () => {
    ...
    store.getState().openFile(
      {
        filePath: '/remote/.agentum/drops/log.txt',
        relativePath: '.agentum/drops/log.txt',
        worktreeId: 'wt-1',
        language: 'text',
        mode: 'edit'
      },
  ...
  it('opens in-worktree file links in Agentum', async () => {
    const store = createEditorStore()
  ...
  it('opens explicit file URLs inside the worktree in Agentum', async () => {
    const store = createEditorStore()
  ...
  it('opens explicit file URLs outside the worktree in Agentum after authorizing them', async () => {
    const store = createEditorStore()
