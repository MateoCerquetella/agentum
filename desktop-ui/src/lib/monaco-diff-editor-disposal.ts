...
type GuardedDiffEditor = editor.IStandaloneDiffEditor & {
  __agentumDiffEditorDisposeGuardInstalled?: true
}

type GuardedEditorNamespace = MonacoDiffEditorNamespace['editor'] & {
  __agentumDiffEditorFactoryGuardInstalled?: true
}
...
export function guardMonacoDiffEditorDispose(
  ...
  if (guardedDiffEditor.__agentumDiffEditorDisposeGuardInstalled) {
    return diffEditor
  }
  ...
  guardedDiffEditor.__agentumDiffEditorDisposeGuardInstalled = true
...
export function installMonacoDiffEditorDisposalGuard(
  ...
  if (editorNamespace.__agentumDiffEditorFactoryGuardInstalled) {
    return
  }
  ...
  editorNamespace.__agentumDiffEditorFactoryGuardInstalled = true
}
