  ...
  return (
    ...
    >
      ...
      {selectionAnnotationTarget && shouldShowMarkdownAnnotations && !commentPopover ? (
        <button
          type="button"
          className="agentum-diff-comment-add-btn"
          style={{
            display: 'flex',
      ...
      <Editor
        ...
        options={{
          ...
          // it aligned with Agentum's app-level opt-out instead of relying on the
        ...
        // would become a second state owner. Agentum restores cursor/scroll from
