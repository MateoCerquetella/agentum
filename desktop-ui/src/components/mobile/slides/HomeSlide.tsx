    ...
    <div className="mp-device-screen">
      <div className="mp-app-topbar">
        <div className="mp-app-brand">
          <AgentumLogo />
          <span className="mp-app-brand-name">Agentum</span>
        </div>
        ...
        <div className="mp-resume-card">
          ...
          <div className="mp-host-main">
            ...
            <div className="mp-resume-sub">
              ...
              <span>agentum&nbsp;&nbsp;·&nbsp;&nbsp;feat/mobile-page</span>
            </div>
          </div>
          <div className="mp-chevron-right">
            <ChevronIcon />
...
function AgentumLogo(): React.JSX.Element {
  return (
    <svg className="mp-agentum-logo" viewBox="0 0 318.60232 202.66667" fill="currentColor" aria-hidden>
