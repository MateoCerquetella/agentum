...
describe('shellEscapePath', () => {
  ...
  it('keeps safe Windows paths unquoted', () => {
    expect(shellEscapePath('C:\\Users\\agentum\\file.txt', 'windows')).toBe(
      'C:\\Users\\agentum\\file.txt'
    )
  })

  it('double-quotes Windows paths with spaces', () => {
    expect(shellEscapePath('C:\\Users\\agentum\\my file.txt', 'windows')).toBe(
      '"C:\\Users\\agentum\\my file.txt"'
    )
  })

  it('double-quotes Windows paths with cmd separators', () => {
    expect(shellEscapePath('C:\\Users\\agentum\\a&b.txt', 'windows')).toBe(
      '"C:\\Users\\agentum\\a&b.txt"'
    )
  })
  ...
  it('uses POSIX escaping for SSH drops regardless of client OS', () => {
    ...
    expect(shellEscapePath("/home/u/wt/.agentum/drops/my file's $draft.txt", 'posix')).toBe(
      "'/home/u/wt/.agentum/drops/my file'\\''s $draft.txt'"
    )
  })
})
